...
// import { ArrowLeft } from "lucide-react-native"; // or use your own SVG/icon
...
//     const mobileRegex = /^[\d\s\-\(\)]{7,15}$/; // Removed + as country code is separate
...
//     return age >= 13 && age <= 150 && date <= today;
//   };
...
//       dob: !dob.trim() || !validateDateOfBirth(dob),
//     };
...
//     return `w-full text-[#1F1E1E] h-[61px] text-lg rounded-[10px] py-5 px-5 ${
//       hasError
...
//     return `w-full text-[#1F1E1E] h-[61px] text-lg rounded-[10px] py-5 px-5 pr-14 ${
//       hasError
//         ? "bg-white border border-[#FF6B6B]"
//         : "bg-white border border-[#B2EBF2]"
//     }`;
...
//       <TextInput
//         className={getInputStyle(fieldErrors.dob) + " mb-8"}
...
//           </View>
//         </TouchableOpacity>
//         <Text className="text-white text-2xl ml-3">Creating New Account</Text>
//       </View>
...
//         // Fixed: Use emailOrMobile instead of undefined identifier
//         const identifier =
...
export default function SignUp() {
  ...
  const getInputStyle = (hasError: boolean) => {
    return `w-full  h-[61px] text-lg rounded-[10px] py-5 px-5 ${
      hasError
